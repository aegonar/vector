...
function relativeY(_ref9) {
  ...
  return point && (yScale(point[projectedYMiddle] || point[projectedY] || (0, _multiAccessorUtils.findFirstAccessorValue)(yAccessor, point)) || 0);
}

function findPointByID(_ref10) {
  var point = _ref10.point,
      idAccessor = _ref10.idAccessor,
      lines = _ref10.lines,
      xScale = _ref10.xScale,
      projectedX = _ref10.projectedX,
      xAccessor = _ref10.xAccessor;
