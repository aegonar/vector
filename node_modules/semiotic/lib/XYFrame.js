...
var XYFrame = (_temp2 = _class = function (_React$Component) {
  ...
  function XYFrame() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = XYFrame.__proto__ || Object.getPrototypeOf(XYFrame)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      if (!d.coordinates) {
        var xCoord = d[_coordinateNames.projectedX] || (0, _multiAccessorUtils.findFirstAccessorValue)(xAccessor, d);
        ...
        screenCoordinates = d.coordinates.map(function (p) {
          return [xScale((0, _multiAccessorUtils.findFirstAccessorValue)(xAccessor, p)) + adjustedPosition[0], (0, _lineDrawing.relativeY)({
            point: p,
            lines: lines,
            projectedYMiddle: _coordinateNames.projectedYMiddle,
            projectedY: _coordinateNames.projectedY,
      ...
      if (_this.props.svgAnnotationRules !== undefined && customSVG !== null) {
        ...
        return (0, _xyframeRules.svgRectEncloseRule)({ d: d, screenCoordinates: screenCoordinates, i: i });
      } else if (d.type === "x") {
      ...
      var xCoord = d[_coordinateNames.projectedX] || (0, _multiAccessorUtils.findFirstAccessorValue)(xAccessor, d);
      var yCoord = d[_coordinateNames.projectedY] || (0, _multiAccessorUtils.findFirstAccessorValue)(yAccessor, d);
