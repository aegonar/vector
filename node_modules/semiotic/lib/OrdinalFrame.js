...
var OrdinalFrame = (_temp = _class = function (_React$Component) {
  _inherits(OrdinalFrame, _React$Component);

  function OrdinalFrame(props) {
    _classCallCheck(this, OrdinalFrame);

    var _this = _possibleConstructorReturn(this, (OrdinalFrame.__proto__ || Object.getPrototypeOf(OrdinalFrame)).call(this, props));
    ...
    _this.calculateOrdinalFrame = function (currentProps) {
      ...
      var _currentProps$oPaddin = currentProps.oPadding,
          padding = _currentProps$oPaddin === undefined ? 0 : _currentProps$oPaddin,
      ...
      var allData = (0, _frameFunctions.keyAndObjectifyBarData)({
        data: data,
        renderKey: renderKey,
        oAccessor: oAccessor,
        rAccessor: rAccessor
      ...
      var arrayWrappedAxis = baseAxis && !Array.isArray(baseAxis) ? [baseAxis] : baseAxis;
      ...
      var oScale = dynamicColumnWidth ? (0, _d3Scale.scaleOrdinal)() : oScaleType();
      ...
      if (pieceType.type === "timeline") {
        ...
        rExtent = (0, _d3Array.extent)([].concat(_toConsumableArray(leftExtent), _toConsumableArray(rightExtent)));
      } else if (pieceType.type !== "bar") {
        rExtent = (0, _d3Array.extent)(allData, function (d) {
          return d.value;
        });
      } else {
        ...
        rExtent = [0, nestedPositiveData.length === 0 ? 0 : Math.max((0, _d3Array.max)(nestedPositiveData, function (d) {
          return d.value;
        }), 0)];

        subZeroRExtent = [0, nestedNegativeData.length === 0 ? 0 : Math.min((0, _d3Array.min)(nestedNegativeData, function (d) {
          return d.value;
        }), 0)];
      ...
      var labelSettings = (typeof oLabel === "undefined" ? "undefined" : _typeof(oLabel)) === "object" ? _extends({ label: true, padding: 5 }, oLabel) : { orient: "default", label: oLabel, padding: 5 };
          ...
          labelingFn = function labelingFn(d, p, i) {
            ...
            return _react2.default.createElement(
              "text",
              {
                ...
                style: _extends({}, labelStyle, additionalStyle)
              },
              d
            );
          };
      ...
      if (pieceHoverAnnotation && ["bar", "clusterbar", "timeline"].indexOf(pieceType.type) !== -1) {
        ...
        columnOverlays = calculatedPieceData.map(function (d, i) {
          var mousePackage = _extends({}, d.piece, {
            x: d.xy.x + _xMod(d.xy),
            y: d.xy.y + _yMod(d.xy)
          });
      ...
      var orFrameRender = {
        ...
        pieces: {
          accessibleTransform: function accessibleTransform(data, i) {
            return _extends({}, data[i].piece ? _extends({}, data[i].piece, data[i].xy) : data[i], {
              type: "frame-hover"
            });
          },
    ...
    _this.defaultORSVGRule = function (_ref) {
      var d = _ref.d,
          i = _ref.i,
      ...
      if (_this.props.svgAnnotationRules && customAnnotation !== null) {
        ...
        return (0, _orframeRules.svgRectEncloseRule)({ d: d, screenCoordinates: screenCoordinates, i: i });
      } else if (d.type === "r") {
    ...
    _this.defaultORHTMLRule = function (_ref2) {
      var d = _ref2.d,
          i = _ref2.i;
      ...
      if (d.type === "frame-hover") {
        var _htmlFrameHoverRule;

        return (0, _orframeRules.htmlFrameHoverRule)((_htmlFrameHoverRule = {
          d: d,
          i: i,
          rAccessor: rAccessor,
          oAccessor: oAccessor,
          ...
          useSpans: useSpans,
          pieceIDAccessor: pieceIDAccessor
        }, _defineProperty(_htmlFrameHoverRule, "projectedColumns", projectedColumns), _defineProperty(_htmlFrameHoverRule, "adjustedSize", adjustedSize), _defineProperty(_htmlFrameHoverRule, "rScale", rScale), _defineProperty(_htmlFrameHoverRule, "type", type), _htmlFrameHoverRule));
  ...
  _createClass(OrdinalFrame, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rAccessor = _props.rAccessor,
          oAccessor = _props.oAccessor,
          name = _props.name,
          ...
          summaryHoverAnnotation = _props.summaryHoverAnnotation,
          pieceHoverAnnotation = _props.pieceHoverAnnotation,
          ...
          canvasPieces = _props.canvasPieces,
          canvasSummaries = _props.canvasSummaries,
      ...
      return _react2.default.createElement(_Frame2.default, {
        ...
        interaction: interaction && _extends({}, interaction, {
  ...
  summaryType: "none",
  useSpans: false
}, _class.displayName = "OrdinalFrame", _temp);
